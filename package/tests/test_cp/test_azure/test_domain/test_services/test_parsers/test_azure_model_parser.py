...
class TestAzureModelsParser(TestCase):
    ...
    def test_convert_to_deploy_azure_vm_resource_model(self, deploy_data_holder_class, jsonpickle,
        ...
        deploy_action.actionParams = mock.MagicMock()
        deploy_action.actionParams.deployment = mock.MagicMock()
        deploy_action.actionParams.deployment.attributes = mock.MagicMock()
    ...
    def test_convert_base_handels_2nd_gen_shell_attributes(self):
        ...
        deploy_action = mock.Mock()
        deploy_action.actionParams = mock.Mock()
        deploy_action.actionParams.deployment = mock.Mock()
        deploy_action.actionParams.deployment.attributes = mock.MagicMock()
        deploy_action.actionParams.appResource = mock.Mock()
        deploy_action.actionParams.appResource.attributes = {'some_namespace.User': 'my_user',
    ...
    def test_convert_to_deploy_azure_vm_from_custom_image_resource_model(self,
        ...
        att = deploy_action.actionParams.deployment.attributes
