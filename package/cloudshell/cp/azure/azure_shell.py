        ...
        with AzureClientFactoryContext(command_context) as azure_clients_factory:
            with LoggingSessionContext(command_context) as logger:
                with ErrorHandlingContext(logger):
                    ...
                    compute_management_client = azure_clients_factory.get_client(ComputeManagementClient)
                    resource_management_client = azure_clients_factory.get_client(ResourceManagementClient)
