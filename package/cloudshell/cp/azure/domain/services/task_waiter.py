...
from cloudshell.cp.azure.common.exceptions import QualiTimeoutException
...
class TaskWaiterService(object):
    ...
    def wait_for_task(self, operation_poller, cancellation_context, wait_time=30, timeout=1800):
