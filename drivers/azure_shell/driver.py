...
class AzureShellDriver(ResourceDriverInterface):
    ...
    def remote_save_snapshot(self, context, ports, cancellation_context, resource_group, snapshot_prefix, disk_type):
        return self.azure_shell.remote_save_snapshot(context=context,
                                                     cancellation_context=cancellation_context,
    ...
    def remote_export_snapshot(self, context, ports, resource_group, snapshot_name):
        return self.azure_shell.remote_export_snapshot(context, resource_group, snapshot_name)
