    ...
    def Deploy(self, context, Name=None):
        with LoggingSessionContext(context) as logger:
            with CloudShellSessionContext(context) as session:
                ...
                deployment_info = self.deployment_helper.get_deployment_info(aws_ami_deployment_model, vm_res_name)

                self.deployment_helper.get_deployment_info(aws_ami_deployment_model)
